...
## План:
 ...
 - [Предобработка данных](#Эксперименты,-проведенные-на-этапе-предобработки-данных)
 ...
 - [А/B тест](#Дизайн-возможного-А/B-теста)
 - [Итоги](#Итоги)
...
## Эксперименты, проведенные на этапе предобработки данных
